...
\pic[shift={""" + offset + """}] at """ + to + """
    {Box={
        ...
        fill=\ImageColor,
        border =""" + border + """,
        fopacity = """ + str(fopacity) + """,
        dopacity =""" + str(bopacity) + """,
        eopacity = """ + str(bopacity) + """,
        height = """ + str(height) + """,
        width = """ + str(width) + """,
        depth = """ + str(depth) + """
        }
...
# Pool
def to_Pool(name, s_filer="", offset="(0,0,0)", to="(0,0,0)", width=1,
            height=32, depth=32, opacity=0.5, caption=" "):
    return r"""
\pic[shift={ """ + offset + """ }] at """ + to + """
    {Box={
        name = """ + name + """,
...
def to_UnPool(name, s_filer="", offset="(0,0,0)", to="(0,0,0)", width=1,
              height=32, depth=32, opacity=0.5, caption=" "):
    return r"""
\pic[shift={ """ + offset + """ }] at """ + to + """
    {Box={
...
def to_ConvRes(name, s_filer=256, n_filer=64, offset="(0,0,0)",
               to="(0,0,0)", width=6, height=40, depth=40, opacity=0.2, caption=" "):
    return r"""
\pic[shift={ """ + offset + """ }] at """ + to + """
    {RightBandedBox={
        name =""" + name + """,
...
# ConvSoftMax
def to_ConvSoftMax(name, s_filer=40, offset="(0,0,0)",
