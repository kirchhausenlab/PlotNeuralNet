...
arch = [ 
    ...
    to_Image("image0",s_filer="",n_filer=304,offset="(-22.4,0,0)",height=60.8,depth=60.8,width=2,caption="Raw"),
    to_input('imgs/raw.png', to="(-22.58,-0.58,-1.5)", width=12.15, height=12.15),

    to_Image("image15","","",offset="(-16.5,0,-5)",height=39.2,depth=39.2,width=2),
    to_input('imgs/crops/offsets.png',to="(-16.5,-0.4,-6.05)",width=7.82,height=7.82),
    to_connection("image0", "image15"),

    to_Image("image16",s_filer="",n_filer=196,offset="(-14.1,-3.00,6)",height=39.2,depth=39.2,width=2,caption="Crop"),
    to_input('imgs/crops/raw.png',to="(-14.1,-3.4,4.96)",width=7.82,height=7.82),
    to_connection("image0", "image16"),

    to_Image("image17","","",offset="(-14.5,0,-5)",height=39.2,depth=39.2,width=2),
    to_input('imgs/crops/orthogs.png',to="(-14.5,-0.4,-6.05)",width=7.82,height=7.82),

    to_Image("image20","","",offset="(-13.5,0.7,-5)",height=39.2,depth=39.2,width=2,fopacity=0.0,bopacity=0.0,caption="Predict"),

    to_Image("image18","","",offset="(-12.5,0,-5)",height=39.2,depth=39.2,width=2),
    to_input('imgs/crops/diags.png',to="(-12.5,-0.4,-6.05)",width=7.82,height=7.82),

    to_Image("image19","","",offset="(-10.5,0,-5)",height=39.2,depth=39.2,width=2),
    to_input('imgs/crops/size.png',to="(-10.5,-0.4,-6.05)",width=7.82,height=7.82),
    ...
    to_connection("image16", "image1"),
    to_connection("image19", "image1"),
    ...
    to_Image("image15",s_filer=3,n_filer="",offset="(24,0,0)",height=18.4,depth=18.4,width=2,caption="Affinities"),
    to_input('imgs/crops/affs.png', to="(24,-0.4,-1.05)",width=3.66,height=3.66),
