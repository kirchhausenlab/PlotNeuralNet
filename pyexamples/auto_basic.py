...
arch = [ 
    ...
    to_Image("image0",s_filer="",n_filer=304,offset="(-17.5,0,0)",height=60.8,depth=60.8,width=2,caption="Raw"),
    to_input('imgs/raw.png', to="(-17.68,-0.58,-1.5)", width=12.15, height=12.15),

    to_Image("image15","","",offset="(-12.2,0,0)",height=39.2,depth=39.2,width=2),
    to_input('imgs/crops/offsets.png',to="(-12.2,-0.4,-1.05)",width=7.82,height=7.82),
    to_connection("image0", "image15"),

    to_Image("image16","","",offset="(-10.2,0,0)",height=39.2,depth=39.2,width=2),
    to_input('imgs/crops/orthogs.png',to="(-10.2,-0.4,-1.05)",width=7.82,height=7.82),

    to_Image("image19","","",offset="(-9.2,0,0)",height=39.2,depth=39.2,width=2,fopacity=0.0,bopacity=0.0,caption="Predict"),

    to_Image("image17","","",offset="(-8.2,0,0)",height=39.2,depth=39.2,width=2),
    to_input('imgs/crops/diags.png',to="(-8.2,-0.4,-1.05)",width=7.82,height=7.82),

    to_Image("image18","","",offset="(-6.2,0,0)",height=39.2,depth=39.2,width=2),
    to_input('imgs/crops/size.png',to="(-6.2,-0.4,-1.05)",width=7.82,height=7.82),
